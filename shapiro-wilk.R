data <-  readRDS("/Users/kjung0909/Documents/Research/WASHB/Pregnancy + Immune/pregnancy-immune/pregnancy_child_immune_covariates_data.rds")

# enrollment characteristics
shapiro.test(data$momage)
shapiro.test(data$momeduy)
shapiro.test(data$hfias)
